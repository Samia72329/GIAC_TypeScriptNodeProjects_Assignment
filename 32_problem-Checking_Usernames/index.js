...
accepted.
*/
var current_users = ["Admin", "Guest", "Micheal Jackson", "Charles Leclerc", "Gabriel", "Nikola Tesla"];
var new_users = ["Jeon Jungkook", "Doremon", "MiCheal JaCKson", "Gojo Saturou", "Light Yagami", "nikola tesla", "guESt"];
new_users.forEach(function (element) {
    if (current_users.some(function (user) { return user.toLowerCase() === element.toLowerCase(); })) {
        console.log("The username: ".concat(element, " is already taken"));
    }
    else {
        console.log("The username: ".concat(element, " is available"));
    }
});
